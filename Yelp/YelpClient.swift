...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func searchWithTerm(term: String, offset: Int, sort: YelpSortMode?, categories: [String]?, deals: Bool?, completion: ([Business]!, NSError!) -> Void) -> AFHTTPRequestOperation {
        ...
        var parameters: [String : AnyObject] = ["term": term, "ll": "37.785771,-122.406165"] //tempe = 33.417582,-111.930887   san francisco = 37.785771,-122.406165
        ...
        if categories != nil && categories!.count > 0 {
            parameters["category_filter"] =  (categories!).joinWithSeparator(",")   //",".join(categories!)
        }
